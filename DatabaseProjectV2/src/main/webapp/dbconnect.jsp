							...
							<form id="server-form-1" method="POST" :form action="submitForm" modelAttribute="formdata">
								<div class="row">
									<div class="col">
										...
										<div class="form-group p-1">
											<label for="serverUrl">Database URL:</label> <input type="text"
												class="form-control" id="serverUrl" placeholder="Enter URL"
												name="serverUrl" required>
										</div>
									</div>
									<div class="col">
										<div class="form-group p-1">
											<label for="database1">Database 1:</label> <input
												type="text" class="form-control" id="database1"
												placeholder="Enter db name" name="database1" required>
										</div>
										<div class="form-group p-1">
											<label for="database2">Database 2:</label> <input
												type="text" class="form-control" id="database2"
