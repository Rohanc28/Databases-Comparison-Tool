  ...
  <nav class="navbar navbar-expand-md navbar-dark bg-secondary">
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="C:\Users\rchaturvedi\Desktop\DB Project\Databases-Comparison-Tool-main\UI\TableView\TableView.html">Recent</a>
        </li>
        <li class="nav-item">
    ...
    <div class="row">
      <div class="col-md-8 offset-md-2">
        ...
        <div class="container my-5">
          <div class="row">
            <div class="col">
              <form id="server-form-1" method="POST" action="/tableSelect">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="databaseName1" placeholder="ex: jon_host.dot.com" name="databaseName" required>
                </div>
                <div class="form-group">
                  <label for="databaseName">Enter Port Number:</label>
                  <input type="number" class="form-control" id="portNumber1" placeholder="ex: 8080" name="databaseName" required>
                </div>
                <div class="form-group">
            ...
            <div class="col">
              <form id="server-form-2" method="POST" action="/tableSelect">
                <div class="form-group">
                  <label for="serverName">Server Name:</label>
                  <div class="input-group mb-3">
                    <div class="input-group-prepend">
                ...
                <div class="form-group">
                  <label for="databaseName">Hostname:</label>
                  <input type="text" class="form-control" id="databaseName2" placeholder="ex: jon_host.dot.com" name="databaseName" required>
                </div>
                <div class="form-group">
                  <label for="databaseName">Enter Port Number:</label>
                  <input type="number" class="form-control" id="portNumber2" placeholder="ex: 8080" name="databaseName" required>
                </div>
                <div class="form-group">
                  <label for="userName" required>Username:</label>
                  <input type="text" class="form-control" id="username2" placeholder="Enter Username" name="userName" required>
                </div>
                <div class="form-group">
                  <label for="password">Password:</label>
                  <input type="password" class="form-control" id="password2" placeholder="Enter password" name="password" required>
