    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav ml-auto">
        <li class="nav-item active">
          <a class="nav-link" href="C:\Users\rchaturvedi\eclipse-workspace\MySpring\src\main\webapp\Index.html">Home</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="C:\Users\rchaturvedi\eclipse-workspace\MySpring\src\main\webapp\ServerConnect.html">Connect</a>
        </li>
        <li class="nav-item">
